...
public class SwipeListViewTouchListener implements View.OnTouchListener {
    ...
    protected void closeAnimate(int position) {
    	View listItemView = swipeListView.getChildAt(position - swipeListView.getFirstVisiblePosition());
    	if(listItemView != null){
    		View listItemFrontView = listItemView.findViewById(swipeFrontView);
    		if(listItemFrontView != null){
    			closeAnimate(listItemFrontView, position);
    		}
    	}
    }
